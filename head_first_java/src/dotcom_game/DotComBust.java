...
public class DotComBust {
    ...
    private void finishGame() {
        System.out.println("All of the sites are down! Your stock is now worthless.");
        if (numOfGuesses <= 18) {
            System.out.println("You only took " + numOfGuesses + " guesses.");
            System.out.println("You got out before your investments sank.");
        } else {
            System.out.println("Took you long enough. " + numOfGuesses + " guesses.");
            System.out.println("Fish are dancing around your investments.");
        }
    }
